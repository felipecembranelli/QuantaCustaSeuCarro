...
namespace YourCarCost.Data
{
    ...
    {
        public CarModel(String uniqueId, String title)
        {
            this.UniqueId = uniqueId;
            this.Title = title;
        }
    ...
    public sealed class SampleDataSource
    {
        ...
        private async Task GetCarModelsAsync()
        {
        ...
        public static async Task<IEnumerable<CarModel>> GetCarModelsAsync1()
        {
            await _sampleDataSource.GetCarModelsAsync();

            return _sampleDataSource.CarModels;
        }
